...
module.exports = [
  ...
  },
  {
      ...
      loaders: [
        {
          test: /\.ts$/,
          exclude: [/node_modules/],
          loader: 'babel-loader?presets[]=es2015&plugins[]=babel-plugin-espower!ts-loader', // first ts-loader(with tsconfig.json), second babel-loader
        },
        {
          test: /\.json$/,
          loader: "json-loader"
    ...
    devtool: 'inline-source-map', // output source map
  }
]